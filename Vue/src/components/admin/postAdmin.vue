    ...
    <div class="content-container" direction="vertical" style="position:absolute;top:30px;left: 200px" :style="{ width: this.globalInfo.bodyWidth + 'px' }">
        ...
        <div class="show" style="height: 98%;overflow: auto">
            ...
            <el-table
                ...
                :data="this.$store.state.articleListInfo.list"
                tooltip-effect="dark"
                height="750"
                empty-text="没有数据"
                style="width: 100%">
                <el-table-column
                    ...
                    <template #default="scope">
                        <div style="text-align:left"><el-image v-if="scope.row['cover']!==''" :src="scope.row['cover']" style="width: 60px; height: 60px"/>
                ...
                <!--                &lt;!&ndash;                    label="相册数量"&ndash;&gt;-->
                <!--                &lt;!&ndash;                    width="100"&ndash;&gt;-->
                <!--                &lt;!&ndash;                    prop="albumnum">&ndash;&gt;-->
                <!--                &lt;!&ndash;                </el-table-column>&ndash;&gt;-->
                <!--                <el-table-column-->
                <!--                    label="注册时间"-->
                ...
                <!--                </el-table-column>-->
                                <el-table-column
                                    ...
                                    width="200">
                                    <template #default="scope">
<!--                                        <el-button @click="openModal(scope.$index)" size="small" type="success">打开用户</el-button>-->
