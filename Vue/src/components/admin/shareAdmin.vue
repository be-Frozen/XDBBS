        ...
        <el-container v-for="(i,index) in this.$store.state.share_info">
            ...
            <el-footer class="commant">
                <el-container style="padding: 0;">
                    <div class="dianzan">
                        <button class="paw-button" style="float:left;">
                    ...
                    <el-button id="uncomment" style="position: relative;float: left;top: 5px; background-color: transparent;border: none; ">
...
export default {
    ...
    mounted () {
        ...
        sharexmlhttp.open("GET", '/' + phpaddr+"?name=", true);
